...
def get_dataloader(adv_batch_size):
...
def get_model(data_dict, device):
    ...
    yolo.hyp = hyp
    yolo.hyp['box'], yolo.hyp['cls'] = 0, 0  # boxes don't matter, neither does (mis)classification doesn't matter
