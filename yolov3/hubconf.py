...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from yolov3.models.common import AutoShape, DetectMultiBackend
    from yolov3.models.experimental import attempt_load
    from yolov3.models.yolo import ClassificationModel, DetectionModel, SegmentationModel
    from yolov3.utils.downloads import attempt_download
    from yolov3.utils.general import LOGGER, ROOT, check_requirements, intersect_dicts, logging
...
if __name__ == "__main__":
    ...
    from yolov3.utils.general import cv2, print_args
